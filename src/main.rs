        ...
        Some((command, matches)) => {
            ...
            match command {
                ...
                "solve" => match level_index {
                    ...
                    13 => solution13::solve(level, &environment_config).await?,
                    ...
                    18 => solution18::solve(level, &environment_config).await?,
                    19 => solution19::solve(level, &environment_config).await?,
                    20 => solution20::solve(level, &environment_config).await?,
                    21 => solution21::solve(level, &environment_config).await?,
                    22 => solution22::solve(level, &environment_config).await?,
                    23 => solution23::solve(level, &environment_config).await?,
                    24 => solution24::solve(level, &environment_config).await?,
                    25 => solution25::solve(level, &environment_config).await?,
                    _ => {}
                },
                "submit" => {
